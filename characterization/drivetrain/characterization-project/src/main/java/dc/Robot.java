...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    double encoderConstant =
        (1.0 / 10.5) * WHEEL_DIAMETER * Math.PI;
    ...
    leftEncoderPosition = ()
        -> (leftMaster.getSelectedSensorPosition(PIDIDX) / 2048.0) * encoderConstant;
    leftEncoderRate = ()
        -> (leftMaster.getSelectedSensorVelocity(PIDIDX) / 2048.0) * encoderConstant *
               10.0;
    ...
    rightEncoderPosition = ()
        -> (rightMaster.getSelectedSensorPosition(PIDIDX) / 2048.0) * encoderConstant;
    rightEncoderRate = ()
        -> (rightMaster.getSelectedSensorVelocity(PIDIDX) / 2048.0) * encoderConstant *
               10.0;
