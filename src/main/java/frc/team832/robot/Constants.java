...
public class Constants {
    ...
    public static final double DEFAULT_ROT_MULTIPLIER = .4;
    public static final double PRECISE_ROT_MULTIPLIER = .15;
    public static final double DEFAULT_MOVE_MULTIPLIER = 1.0;
    public static final double PRECISE_MOVE_MULTIPLIER = .2;
    public static final double DEFAULT_TANK_MULTIPLIER = 0.7;
    public static final double PRECISE_TANK_MULTIPLIER = 0.7;
